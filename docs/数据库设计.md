...
**支持的平台**：GitHub、Google、Twitter、Yandex、Gitee、QQ、Baidu、爱发电、微博、LinuxDo、Microsoft、GitLab、语雀、华为、小米、Apple，另支持自定义 OAuth2/OIDC 平台（custom，可对接 Keycloak、Casdoor、Logto 等自建 SSO，通过 authorize_url/token_url/user_info_url 与 uid_field 等字段映射列配置）
