  ...
  >
    ...
    <transition name="fade">
      ...
      >
        ...
        />
        <!-- 亮色模式图标 -->
        <svg v-if="avatarLoadFailed && !isDarkMode" class="ai-icon avatar-fallback-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- 暗色模式图标（白色） -->
        <svg v-else-if="avatarLoadFailed" class="ai-icon avatar-fallback-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  setup() {
    ...
    const chatAvatarUrl = computed(() => getAiAvatarUrl(chatAvatar.value))
