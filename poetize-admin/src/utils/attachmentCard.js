...
const ATTACHMENT_TITLE = 'pb-attachment';
...
export function transformAttachmentLinksInElement(root) {
  ...
  root.querySelectorAll('a[href]').forEach((link) => {
    ...
    card.className = 'pb-attachment-card';
    card.setAttribute('data-pb-attachment', 'true');
    card.setAttribute('data-pb-attachment-href', href);
    card.setAttribute('data-pb-attachment-name', name);
    if (isPrivate) {
      card.setAttribute('data-pb-private-attachment', 'true');
    }

    const icon = document.createElement('span');
    icon.className = 'pb-attachment-pill-icon';
    ...
    title.className = 'pb-attachment-pill-name';
    title.textContent = name;

    const meta = document.createElement('span');
    meta.className = 'pb-attachment-pill-meta';
    meta.textContent = isPrivate ? `${extension} · 登录可见` : extension;

    const actions = document.createElement('span');
    actions.className = 'pb-attachment-pill-actions';

    if (canPreview) {
      const preview = document.createElement('a');
      preview.className = 'pb-attachment-pill-btn';
      ...
      preview.setAttribute('data-pb-attachment-action', 'preview');
      preview.setAttribute('title', '预览');
      actions.appendChild(preview);
    }

    const download = document.createElement('a');
    download.className = 'pb-attachment-pill-btn';
    ...
    download.setAttribute('data-pb-attachment-action', 'download');
